...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-semibold ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:bg-neutral-100 disabled:from-neutral-100 disbled:to-neutral-100 disabled:text-neutral-300 border border-neutral-200 shadow-sm",
  {
    variants: {
      variant: {
        default:
          "bg-gradient-to-b from-blue-600 to-blue-600 text-primary-foreground  hover:from-blue-700 hover:to-blue-700",
        destructive:
        ...
        teritrary: "bg-blue-100 text-blue-600 bordr-transparent hover:bg-blue-200 shadow-none"
      },
      size: {
